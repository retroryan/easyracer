...
public class OriginalScenarios {
    private final URI url;
    private final HttpClient client;
    private static final Logger LOGGER = Logger.getLogger(OriginalScenarios.class.getName());

    public OriginalScenarios(URI url) {
        this.url = url;
    ...
    public String scenario1() throws ExecutionException, InterruptedException {
        ...
        try (
                var scope = new StructuredTaskScope.ShutdownOnSuccess<HttpResponse<String>>()) {
